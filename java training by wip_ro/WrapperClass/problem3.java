/*
Define a java class that accepts an integer(between 1 and 255) from the user and 
displays the String representation of the argument passed as an unsigned integer in base 2. 
...
class problem3{
	public static void main(String args[]){
		System.out.println("enter the number in range from 1 to 255");
